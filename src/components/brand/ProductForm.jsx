            ...
            <div>
              ...
              <div className="flex gap-2 mb-4 border rounded-lg p-1 bg-neutral-50">
                <button
                  ...
                  className={`flex-1 py-2 px-4 rounded-md font-medium transition ${imageMode === 'upload'
                ...
                <button
                  ...
                  className={`flex-1 py-2 px-4 rounded-md font-medium transition ${imageMode === 'url'
                      ? 'bg-blue-600 text-white'
                      : 'text-neutral-700 hover:bg-neutral-100'
                    }`}
                >

  ...
  return (
    <div style={{ minHeight: '100vh', backgroundColor: '#fafafa', fontFamily: '-apple-system, BlinkMacSystemFont, "Segoe UI", sans-serif' }}>
      ...
      {/* ══════════════════════════════════════════
          HERO SECTION — FIXED
          Changes:
          1. Reduced padding so stats are fully visible
          2. Tighter gap between pill/heading/subtext
          3. Shorter subtext (one line)
          4. Smaller, more refined buttons
      ══════════════════════════════════════════ */}
      <section style={{
        background: 'linear-gradient(135deg, #4338ca 0%, #6366f1 45%, #ec4899 80%, #f43f5e 100%)',
        padding: '3.5rem 1.5rem 3rem',   /* ✅ FIX 1: reduced padding */
        position: 'relative',
        overflow: 'hidden',
        display: 'flex',
        alignItems: 'center',
        ...
        <div style={{ maxWidth: '1400px', margin: '0 auto', width: '100%', textAlign: 'center', position: 'relative', zIndex: 1 }}>
          ...
          <div style={{
            ...
            marginBottom: '0.9rem',    /* ✅ FIX 2: tighter gap */
            letterSpacing: '0.4px',
          }}>
          ...
          <h1 style={{
            ...
            color: 'white',
            lineHeight: 1.1,
            marginBottom: '0.6rem',    /* ✅ FIX 2: tighter gap */
            letterSpacing: '-1.5px',
            whiteSpace: 'nowrap',
          }}>
            Welcome to{' '}
          ...
          {/* Subheading — short & one line */}
          <p style={{
            fontSize: '1rem',
            color: 'rgba(255,255,255,0.8)',
            margin: '0 auto 1.5rem',   /* ✅ FIX 2: tighter gap */
            whiteSpace: 'nowrap',      /* ✅ FIX 3: force single line */
            letterSpacing: '0.1px',
          }}>
            Discover trends, connect with creators, and shop with confidence.
          </p>

          {/* CTA Buttons — smaller & refined */}
            ...
            {user ? (
              <button
                ...
                style={{
                  ...
                  borderRadius: '9999px', padding: '0.6rem 1.6rem',  /* ✅ FIX 4: smaller */
              ...
              <>
                ...
                <button
                  ...
                  style={{
                    ...
                    padding: '0.6rem 1.6rem',                          /* ✅ FIX 4: smaller */
          ...
          <div style={{
            ...
            {[['10K+', 'Products'], ['500+', 'Brands'], ['50K+', 'Customers']].map(([num, label], i) => (
              <div key={label} style={{
                padding: '0.75rem 1.75rem',  /* ✅ FIX 1: smaller padding so fully visible */
                textAlign: 'center',
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))', gap: '1.5rem' }}>
            ...
            <div style={{ background: 'white', borderRadius: '20px', padding: '2rem', border: '1.5px solid #d1fae5', boxShadow: '0 4px 24px rgba(16,185,129,0.08)', position: 'relative', overflow: 'hidden' }}>
              ...
              <div style={{ display: 'inline-flex', alignItems: 'center', gap: '0.5rem', background: '#d1fae5', borderRadius: '9999px', padding: '0.35rem 0.9rem', marginBottom: '1.5rem' }}>
                <span>🛍️</span><span style={{ fontWeight: 700, color: '#065f46', fontSize: '0.85rem' }}>For Buyers (Customers)</span>
              </div>
              <div style={{ display: 'flex', flexDirection: 'column', gap: '1.1rem' }}>
      ...
      <footer style={{ background: '#18181b', padding: '4rem 1.5rem 2rem', color: '#71717a' }}>
        <div style={{ maxWidth: '1400px', margin: '0 auto' }}>
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(180px, 1fr))', gap: '2.5rem', marginBottom: '3rem' }}>
            <div>
              <div style={{ fontFamily: 'Georgia, serif', fontSize: '1.4rem', fontWeight: 700, background: 'linear-gradient(135deg, #818cf8, #fb7185)', WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent', backgroundClip: 'text', marginBottom: '0.75rem', display: 'block' }}>🛍️ MarketNest</div>
          ...
          <div style={{ borderTop: '1px solid #27272a', paddingTop: '1.75rem', display: 'flex', justifyContent: 'space-between', alignItems: 'center', flexWrap: 'wrap', gap: '0.75rem' }}>
            <p style={{ fontSize: '0.84rem', color: '#52525b', margin: 0 }}>© 2026 MarketNest. All rights reserved. Made with ❤️ using MERN Stack</p>
